...
class IntelligenceEngine {
  ...
  static generateIntelligence(client, details) {
    const intelligence = {
      ...
      differentiator_score: this.calculateDifferentiatorScore(details) || 7.0,
      market_score: this.calculateMarketScore(details) || 7.0,
      product_score: this.calculateProductScore(details) || 7.0,
      pricing_score: this.calculatePricingScore(details) || 7.0,
      moat_score: this.calculateMoatScore(details) || 7.0,
      overall_score: 0,
      verdict: '',
